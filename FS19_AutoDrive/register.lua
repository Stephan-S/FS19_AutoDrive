...
source(Utils.getFilename("scripts/Events/AutoDriveGroupsEvent.lua", AutoDrive.directory))
...
source(Utils.getFilename("scripts/Events/AutoDriveChangeMapMarkerGroupEvent.lua", AutoDrive.directory))
