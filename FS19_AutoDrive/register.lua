...
source(Utils.getFilename("scripts/AutoDriveRoutesManager.lua", g_currentModDirectory))
...
source(Utils.getFilename("scripts/Utils/AutoDriveTrailerUtil.lua", g_currentModDirectory))
